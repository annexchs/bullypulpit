...
<html>
    ...
    <head>
    	...
    	<link rel="stylesheet" href="<?php echo $this->getThemePath(); ?>/styles/surveys.css">
    ...
    <div id="box27" class="clearfix">
        <div id="left-column" class="clearfix">
          <?php
            $as = new Area('Main');
            $as->setBlockWrapperStart('<div class="blog">');
            $as->setBlockWrapperEnd('</div>');
            $as->display($c);
          ?>

          <?php
            $ad = new Area('Page Controls');
            $ad->display($c);
          ?>
     ...
     <div id="box33" class="clearfix">
            <div id="box34" class="clearfix">
                ...
                <p id="text33">
                &copy; COPYRIGHT 2014 COLLEGE OF CHARLESTON. ALL RIGHTS RESERVED. DESIGNED IN CHARLESTON BY ANNEX STUDIO.<br />
                </p>
            </div>
        </div>
