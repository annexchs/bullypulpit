            ...
            <div id="left-column" class="clearfix">
              ...
              <?php
                      ...
                      foreach ($pages as $p) {
                        ...
                        $eventLink = $nh->getLinkToCollection($p);
                        echo '<h1><a href="',$eventLink,'">',$p->getCollectionName(),'</a></h1>';
                        echo '<h2>',$p->getAttribute('event_subhead'),'</h2>';
                        ...
                        echo '<p>',$p->getCollectionDescription(),'</p>';
                        echo '<hr />';
                      }
